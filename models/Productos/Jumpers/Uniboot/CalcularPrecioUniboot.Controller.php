...
}if (!class_exists("CalcularPrecioUniboot")) {
  include $_SERVER["DOCUMENT_ROOT"].'/fibra-optica/models/Productos/Jumpers/Uniboot/CalcularPrecioUniboot.Model.php';
}

  /**
   * 
   */
  class CalcularPrecioUnibootController{
    ...
    public function Calcular(){
      try {
        if (!$this->Connection->conexion()->connect_error) {
          $CalcularPrecioEspecialesModel = new CalcularPrecioUniboot(); 
          ...
          $CalcularPrecioEspecialesModel->SetDiametros($_POST['Diametros']);
