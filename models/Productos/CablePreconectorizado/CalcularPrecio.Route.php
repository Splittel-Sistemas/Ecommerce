<?php
	...
	if (!class_exists("Seguridad")) {
		...
		include $_SERVER['DOCUMENT_ROOT'].'/fibra-optica/models/Productos/CablePreconectorizado/CalcularPrecio.Controller.php';
	}
	...
	if ($SeguridadController->decryptData() && $_POST['ActionPrecioPreconectorizados']) { 
