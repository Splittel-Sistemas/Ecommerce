          ...
          if ($ClienteExiste) {
            ...
            if ($ContactoExiste) {
              $WebServiceSOAP = new WebService(
                "http://".$ContactoModel->GetWebservice()."/WS_Invoice.asmx?WSDL", 
              ...
              $GetFileInvoice['GetFileInvoice'] = ['DocEntry' => $this->DocEntry, 'Typefile' => $this->TypeFile];

              $result = $WebServiceSOAP->ExecuteSoap("GetFileInvoice", $GetFileInvoice, false);
