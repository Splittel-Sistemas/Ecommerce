 ...
 */
  ...
  class GetBillToAdressController{
        ...
        if (!$this->conn->conexion()->connect_error) {
          ...
          if ($ClienteExiste) {
            ...
            if ($ContactoExiste) {
              ...
              $GetBillToAdress['GetBillToAdress'] = ['CardCode' => $ClienteModel->GetCardCode()];

              $result = $WebServiceSOAP->ExecuteSoap("GetBillToAdress", $GetBillToAdress, false);
