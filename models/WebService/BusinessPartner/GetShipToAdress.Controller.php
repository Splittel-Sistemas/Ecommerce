 ...
 */
  ...
  class GetShipToAdressController{
        ...
        if (!$this->conn->conexion()->connect_error) {
          ...
          if ($ClienteExiste) {
            ...
            if ($ContactoExiste) {
              ...
              $GetShipToAdress['GetShipToAdress'] = ['CardCode' => $ClienteModel->GetCardCode()];

              $result = $WebServiceSOAP->ExecuteSoap("GetShipToAdress", $GetShipToAdress, false);
