 ...
 */
  ...
  class GetBussinesPartnerController{
        ...
        if (!$this->conn->conexion()->connect_error) {
          ...
          if ($ClienteExiste) {
            ...
            if ($ContactoExiste) {
              ...
              $GetBussinesPartner['GetBussinesPartner'] = ['CardCode' => $ClienteModel->GetCardCode()];

              $result = $WebServiceSOAP->ExecuteSoap("GetBussinesPartner", $GetBussinesPartner, false);
