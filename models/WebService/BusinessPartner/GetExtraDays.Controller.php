        ...
        if (!$this->conn->conexion()->connect_error) {
          ...
          if ($ClienteExiste) {
            ...
            if ($ContactoExiste) {
              ...
              $GetExtraDays['GetExtraDays'] = ['CardCode' => $ClienteModel->GetCardCode()];

              $result = $WebServiceSOAP->ExecuteSoap("GetExtraDays", $GetExtraDays, false);
