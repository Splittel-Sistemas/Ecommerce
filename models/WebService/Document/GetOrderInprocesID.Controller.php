 ...
 */
  ...
  class GetOrderInprocesIDController{
        ...
        if (!$this->conn->conexion()->connect_error) {
          ...
          if ($ClienteExiste) {
            ...
            if ($ContactoExiste) {
              ...
              $GetOrderInprocesID['GetOrderInprocesID'] = ["NumEcommerce" => $this->PedidoKey];
              $result = $WebServiceSOAP->ExecuteSoap("GetOrderInprocesID", $GetOrderInprocesID, false);
              // print_r($result);
  ...
  // $GetOrderInprocesIDController->get();