    ...
    public function get($return_json){
      try {
        ...
        $WebServiceSOAP = new WebService(
          "http://".$EcommContacto_Webservice."/WS_Payment.asmx?WSDL", 
        ...
        $GetDocumentsPayment['GetDocumentsPayment'] = ['DocEntry' => $this->DocEntry];

        $result = $WebServiceSOAP->ExecuteSoap("GetDocumentsPayment", $GetDocumentsPayment, $return_json);
