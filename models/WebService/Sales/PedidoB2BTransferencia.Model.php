<?php 
  ...
  class PedidoB2BTransferencia{
     ...
     * @return int $b Bar
     */
    public function createPedidoB2BWithOutCredit($WebServiceSOAP, $ArticulosPedido){
      try {
       ...
       // $this->TransportationCode = 1;
        ...
        $result = $WebServiceSOAP->ExecuteSoap("CreatePedidoB2B_withoutCredit", $this->EstructuraPedidoB2B, false);
        return $result;
      } catch (Exception $e) {
        throw $e;
      }
