<?php 
  ...
  }if (!class_exists("PedidoB2B")) {
    include $_SERVER["DOCUMENT_ROOT"].'/fibra-optica/models/WebService/Sales/PedidoB2B.Model.php';
    ...
    public function create(){
      try {
        if (!$this->conn->conexion()->connect_error) {
          ...
          $ResultPedidoController = $PedidoController->GetPedidoB2B_();
