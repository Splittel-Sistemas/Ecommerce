  ...
  class GetShipToAdress
  {
    ...
    public function get($return_json){
      try {
        ...
        $GetShipToAdress['GetShipToAdress'] = ['CardCode' => $PersonalCliente->PersonalCardcode];

        $result = $WebServiceSOAP->ExecuteSoap("GetShipToAdress", $GetShipToAdress, $return_json);
