  ...
  class GetBussinesPartner
  {
    ...
    public function get($return_json){
      try {
        ...
        $GetBussinesPartner['GetBussinesPartner'] = ['CardCode' => $PersonalCliente->PersonalCardcode];

        $result = $WebServiceSOAP->ExecuteSoap("GetBussinesPartner", $GetBussinesPartner, $return_json);
