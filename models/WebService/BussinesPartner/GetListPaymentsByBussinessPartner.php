  ...
  class GetListPaymentsByBussinessPartner
  {
    ...
    public function get($return_json){
      try {
        ...
        $GetListPaymentsByBussinessPartner['GetListPaymentsByBussinessPartner'] = [
          'CardCode' => $PersonalCliente->PersonalCardcode,
          'fecha1' => $this->FechaInicial,
          'fecha2' => $this->FechaFin
        ];

        $result = $WebServiceSOAP->ExecuteSoap("GetListPaymentsByBussinessPartner", $GetListPaymentsByBussinessPartner, $return_json);
