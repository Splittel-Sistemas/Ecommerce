    ...
    class GetOrdersByCustomer
    {
        public function get($return_json){
            try {
                ...
                $GetFisrtBuy['GetOrdersByCustomer'] = ['CardCode' => $PersonalCliente->PersonalCardcode];
        
                $result = $WebServiceSOAP->ExecuteSoap("GetOrdersByCustomer", $GetFisrtBuy, $return_json);
