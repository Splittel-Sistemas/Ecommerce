    ...
    class EnProceso
    {
        public function get($return_json){
            try {
                ...
                $GetFisrtBuy['GetOrdersInProcessEcommerce'] = ['CardCode' => $PersonalCliente->PersonalCardcode];
        
                $result = $WebServiceSOAP->ExecuteSoap("GetOrdersInProcessEcommerce", $GetFisrtBuy, $return_json);
