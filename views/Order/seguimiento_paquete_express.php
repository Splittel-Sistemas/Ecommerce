    ...
    <?php 
      ...
      $Result = $NumeroGuiaEstatus_Controller->GetPedidoEstatusPaqueteriaPaqueteExpress();
    ...
    <div class="container padding-bottom-3x mb-1">
      <div class="card mb-3">
        ...
        <div class="d-flex flex-wrap flex-sm-nowrap justify-content-between py-3 px-2 bg-secondary">
          <div class="w-100 text-center py-1 px-2"><span class='text-medium'>Enviado a tráves de:</span> Paquete Express</div>
          <div class="w-100 text-center py-1 px-2"><span class='text-medium'>Estatus:</span> <?php echo utf8_decode($UltimoEvento->status) ?></div>
            ...
            <div class="tab-pane fade show active" id="inf1" role="tabpanel">
              <div class="table-responsive">
                <table class="table table-hover">
                  ...
                  <tbody>
                    <?php 
                      foreach ($Result->records['Evento'] as $key => $Evento) {
                    ?>
                    <tr>
                      <td class="text-center align-middle"><?php echo $Evento->fecha; ?></td>
                      <td class="text-center align-middle"><?php echo $Evento->hora; ?></td>
                      <td class="align-middle"><?php echo utf8_decode($Evento->status); ?></td>
                      <td class="text-center align-middle"><?php echo utf8_decode($Evento->sucursal); ?></td>
                    </tr>
                    <?php } ?>
                  </tbody>
                </table>
