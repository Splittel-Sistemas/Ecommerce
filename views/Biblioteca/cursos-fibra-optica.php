    ...
    <?php if ($response->count > 0): ?>
      ...
      <div class="row align-items-center padding-bottom-2x padding-top-2x">
        ...
        <div class="col-md-7 text-md-left text-center">
          ...
          <a class="text-decoration-none" href="cursos_detalle.php?id=<?php echo $row->id;?>&nom=<?php echo url_amigable($row->nombre);?>">Conocer más&nbsp;<i class="icon-arrow-right d-inline-block align-middle"></i></a>
        </div>
      </div>
      <hr>
      <?php endforeach ?>
