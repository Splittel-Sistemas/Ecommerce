      ...
      <div style="max-width: 500px;">
        ...
        <form id="form-datos-envio">
          ...
          <input type="hidden" id="DatosEnvioKey" name="DatosEnvioKey" value="<?php echo $key ?>">
            ...
            <div class="form-group">
              <input class="form-control form-control-pill" type="text" id="Delegacion" name="Delegacion" placeholder="Delegación" value="<?php echo $DatosEnvio->GetDelegacion() ?>" autocomplete="off">
            </div>
            <div class="form-group">
