  ...
  <table class="table">
    ...
    <tbody>
      ...
      ?>
          ...
          <!-- Subtotal -->
          <td class="text-center text-lg">
            $ <?php echo $data->DetalleSubtotalMXN ?> MXP
          </td>
      <?php
...
<div class="shopping-cart-footer">
  <div class="column text-lg">
    ...
    ?>
    <span class="text-muted">Costo Envio:&nbsp; </span><span class="text-gray-dark">$ <?php echo $Obj->DetalleSubtotalMXN ?> MXP</span><br>
    <?php } ?>
    <span class="text-muted">Subtotal:&nbsp; </span><span class="text-gray-dark">$ <?php echo $pedidoSubtotal ?> MXP</span><br>
    <span class="text-muted">Iva:&nbsp; </span><span class="text-gray-dark">$ <?php echo $pedidoIva ?> MXP</span><br>
    <span class="text-muted">Total:&nbsp; </span><span class="text-gray-dark">$ <?php echo $pedidoTotal ?> MXP</span>
    <input type="hidden" name="TotalValidacion" id="TotalValidacion" value="<?php echo $pedidoTotal ;?>">
  </div>
</div>