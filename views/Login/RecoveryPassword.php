      ...
      <div class="row justify-content-center">
        <div class="col-lg-8 col-md-10">
          ...
          <ol class="list-unstyled">
            ...
            <li><span class="text-primary text-medium">3. </span>Use el código para iniciar sesion, en el primer inisio de sesion se solicitara cambiar su contraseña en nuestro sitio web.</li>
          </ol>
          <form class="card mt-4" id="RecoveryForm">
            <div class="card-body">
              <div class="form-group">
                ...
                <br>
                Escriba la dirección de correo electrónico que utilizó para registrase, Luego enviaremos un código por correo electrónico a esta dirección</small>
              </div>
            </div>
