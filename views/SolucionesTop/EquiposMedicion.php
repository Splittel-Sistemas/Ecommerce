  ...
  <div class="container padding-top-3x  ">
    <div class="row justify-content-center">
      ...
      <div class="col-xl-8 col-lg-8 order-lg-2">
        ...
        $SolucionesTopController->filter = "WHERE nombre = 'Equipos de Medicion' ";
        ...
        <div class="row">
          ...
          ?>
            ...
            <div class="col-lg-12 col-md-12 order-md-2">
              <div class="gallery-wrapper">
                <div class="gallery-item">
                  <img alt="" class="rounded" src="../../public/images/img_spl/solucionestop/<?= $row->Nombre . "/banners/" . $row->Banner1 ?>" alt="Equipos de Medicion">
            ...
            <div class="col-lg-6 col-md-6 order-md-2  margin-top-2x">
              ...
              <h5 style="color:#999999" class="text-center    margin-top-1x">
    ...
    <div class="row justify-content-center">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6 order-md-2  padding-top-2x">
            ...
            <h6 class=" text-center text-normal ">
              ...
              <br>
              <h5 class="text-center    margin-top-1x" style="color:#999999">
                <?= $row->App1 ?>
      ...
      -->
          ...
          <div class="col-lg-12 col-md-8 order-md-2">
            ...
            <h6 class=" text-center text-normal ">
              <img alt="" width="200" src="../../public/images/img_spl/solucionestop/Equipos de Medicion/Extra_1.png">
            </h6>
          ...
          <div class="col-lg-12 col-md-8 order-md-2 margin-top-2x ">
            ...
            <h6 class=" text-left text-normal " style="font-size : 14px;color:#999999">
              <?= $row->Texto3 ?>
            </h6>

            <h6 class=" text-center text-normal margin-top-1x">
              <a target="_blank" href="<?= $row->Whatslink ?>"><img alt="" width="350" src="../../public/images/img_spl/solucionestop/Equipos de Medicion/boton.png"></a>
            </h6>
          ...
          <div class="col-lg-8 offset-md-2  order-md-2 margin-top-1x">
            ...
            <h6 class=" text-center text-normal ">
              <img alt="" src="../../public/images/img_spl/solucionestop/Equipos de Medicion/Extra_2.png">
            </h6>
