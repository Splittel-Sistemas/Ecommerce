      ...
      <div class="col-xl-9 col-lg-8 order-lg-2">
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6 order-md-2  margin-top-4x" ">
            ...
            <div class=" gallery-wrapper">
            <div class="gallery-item">
              <h5 class="text-center text-muted opacity-85   margin-top-1x"><b>Puertas configurables </b> <br>para cubrir distintas necesidades <br> de ventilacion y protección</h5>
        ...
        <div class="col-lg-6 col-md-6 order-md-2  margin-top-1x" style="padding-top: 20px;">
          ...
          <h6 class=" text-center text-normal ">
            ...
            <h5 class="text-center text-muted opacity-85  ">Control del flujo de aire</h5>
          </h6>
        ...
        <div class="col-lg-6 col-md-6 order-md-2 ">
          ...
          <h5 class="text-center text-muted opacity-85   ">Sistema de protección <br> y embalaje sin cargo extra</h5>
        ...
        <div class="col-lg-6 col-md-6 order-md-2  margin-top-2x">
          ...
          <h6 class=" text-center text-normal ">
            ...
            <h5 class="text-center text-muted opacity-85   margin-top-1x">Estandarización para equipos de 19’’</h5>
          </h6>
        ...
        <div class="col-lg-6 col-md-6 order-md-2  margin-top-2x">
          ...
          <h6 class="  text-normal ">
            ...
            <h5 class="text-center text-muted opacity-85   margin-top-1x">Envío gratuito a toda la república</h5>
          </h6>
        ...
        <div class="col-lg-12 col-md-8 order-md-2">
          ...
          <h4 class="text-center  margin-top-3x">
            <strong>Racks</strong>
          </h4>
        </div>
        ...
        <div class="col-lg-6 col-md-6 order-md-2  margin-top-2x">
          ...
          <h6 class=" text-center text-normal ">
            ...
            <h5 class="text-center text-muted opacity-85   margin-top-1x">Configuración especial <br> para paredes</h5>
          </h6>
        ...
        <div class="col-lg-6 col-md-6 order-md-2  margin-top-2x">
          ...
          <h5 class="text-center text-muted opacity-85   margin-top-1x">Diferentes capacidades de carga</h5>
        ...
        <div class="col-lg-6 col-md-6 order-md-2  margin-top-2x">
          ...
          <h6 class=" text-center text-normal ">
            ...
            <h5 class="text-center text-muted opacity-85   margin-top-1x">Cumple con especificaciones <br>
              EIA-310-E</h5>
          </h6>
        ...
        <div class="col-lg-6 col-md-6 order-md-2  margin-top-2x">
          ...
          <h6 class="  text-normal ">
            ...
            <h5 class="text-center text-muted opacity-85   margin-top-1x">Carga estática adaptable <br>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6 order-md-2 ">
            ...
            <h6 class=" text-center text-normal margin-top-2x">
              ...
              <br>
              <h5 class="text-center text-muted opacity-85   margin-top-1x">
