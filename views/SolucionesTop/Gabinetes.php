        ...
        <div class="row">
          ...
          ?>
            ...
            <div class="col-lg-12 col-md-12 order-md-2  margin-top-2x">
              ...
              <div class="gallery-wrapper">
                <div class="gallery-item">
                  ...
                  <h5 class="text-center text-muted opacity-75 margin-top-1x">Puertas configurables según tu espacio</h5>
            ...
            <div class="col-lg-6 col-md-6 order-md-2">
              ...
              <h5 class="text-center text-muted opacity-75 margin-top-1x">Sistema de protección <br> y embalaje sin cargo extra</h5>
