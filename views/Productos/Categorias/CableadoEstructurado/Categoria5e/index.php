  <div class="row align-items-end pb-4">
    <div class="col-sm-4" id="ColorSelect">
      <div class="form-group mb-0">
        ...
        <select class="form-control" id="Color" name="Color" onchange="Categoria5e()">
    ...
    <div class="col-sm-4" id="LongitudInput">
      <div class="form-group mb-0">
        ...
        <input type="text" maxlength="3" class="form-control" id="Longitud" name="Longitud" value="1" onkeyup="Categoria5e()">
      </div>
    </div> 
  </div>