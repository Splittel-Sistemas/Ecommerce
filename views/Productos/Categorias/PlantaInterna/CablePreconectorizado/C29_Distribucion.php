<div class="row align-items-end pb-4" id="">
    ...
    <div class="form-group mb-0">
      <label for="quantity">Tipo de terminacion</label>
        <select class="form-control" id="TipoTerminacion" name="TipoTerminacion" onchange="interior_exterior_cable()">
            <option onselect="" value="9UM">900 um</option>
            <option onselect="" value="2MM">2 mm</option>
    ...
    <div class="form-group mb-0">
      <label for="quantity">Tipo de cubierta</label>
        <select class="form-control" id="TipoCubierta" name="TipoCubierta" onchange="interior_exterior_cable()">
            ...
            <option value="Z">Cero Halogeno</option>
        </select>
    </div>
  </div>
  <div class="col-sm-4">
  ...
  <div class="col-sm-4">
    <div class="form-group mb-0">
        ...
        <input class="form-control" maxlength="2" type="text" value="" id="NoHilos" name=""  onkeyup="interior_exterior_cable()">
    </div>
  </div>
  <div class="col-sm-4">
    <div class="form-group mb-0">
        <label for="quantity">Longitud <span id="Longitud_label">1-999 (m)</span></label>
        <input class="form-control" maxlength="3" type="text" value="" id="Longitud" name=""  onkeyup="interior_exterior_cable()">
    </div>
  </div>
  <div class="col-sm-4">
    <div class="form-group mb-0">
