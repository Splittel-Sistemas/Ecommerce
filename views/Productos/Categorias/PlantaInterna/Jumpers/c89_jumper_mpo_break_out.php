<div class="row align-items-end pb-4">
  ...
  <div class="col-sm-4" id="ConectorLadoASelect">
    <div class="form-group mb-0">
      ...
      <select class="form-control" id="ConectorLadoA" name="ConectorLadoA" onchange="JumpersFibraOptica()">
        <option value="A1">MPO</option>
      </select>
    </div>
  </div>
  <!-- Conector Lado B -->
  <div class="col-sm-4" id="ConectorLadoBSelect">
    <div class="form-group mb-0">
      ...
      <select class="form-control" id="ConectorLadoB" name="ConectorLadoB" onchange="JumpersFibraOptica()">
        <option value="AE">LCP dúplex</option>
      </select>
    </div>
  </div>
  <!-- Polaridad -->
  ...
  <div class="col-sm-4" id="DisenoSelect">
    <div class="form-group mb-0">
      <label for="quantity">Diseño MPO</label>
  ...
  <div class="col-sm-4" id="LongitudBreakOutSelect">
    <div class="form-group mb-0">
      ...
      <select class="form-control" id="LongitudBreakOut" name="LongitudBreakOut" onchange="JumpersFibraOptica()">
