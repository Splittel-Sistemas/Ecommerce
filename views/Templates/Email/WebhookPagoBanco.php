<?php
  ...
  class TemplateWebhookPagoBanco{
    /**
                    ...
                    <td class="container">
                      <div class="content">
                        ...
                        <table role="presentation" class="main">
                          ...
                          <tr>
                            <td class="wrapper">
                              <p align="center" style="margin-bottom:10px;">'.$data['Message'].'</p>
                              <p align="center" style="margin-bottom:10px;"><strong>Descripcion: </strong>'.$data['Descripcion'].'</p>
                              <p align="center" style="margin-bottom:10px;"><strong>Pedido: </strong>'.$data['Pedido'].'</p>
                              <p align="center" style="margin-bottom:10px;"><strong>Fecha: </strong>'.$data['Fecha'].'</p>
                              <p align="center" style="margin-bottom:10px;"><strong>Monto Total: </strong>'.$data['Monto'].'</p>
                              <p><br></p>
