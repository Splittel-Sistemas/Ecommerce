    ...
    <div class="container padding-bottom-3x mb-2">  
      <div class="card text-center">
        ...
        <p><img src="../../public/images/img_spl/iconos/close.png" width="200px" height="200px" /></p>
          ...
          <div class="padding-top-1x padding-bottom-1x"><a class="btn btn-outline-primary" onclick="window.parent.location.href='../Login/logout.php'"><i class="icon-cart"></i>&nbsp;Reintentar</a></div>
        </div>
      </div>
    </div>
  </body>
