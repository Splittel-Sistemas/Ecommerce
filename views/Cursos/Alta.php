  ...
  ?>
    ...
    <div class="container padding-top-1x padding-bottom-3x mb-2">
        ...
        <div class="steps flex-sm-nowrap mb-5">
            <a class="step process active" id="process-1" number="1" data-toggle="pill" data-target="#pills-home"
                type="button " role="tab" aria-controls="pills-home" aria-selected="true"
                onclick="addViewCheckout(this)">
                    ...
                    <div class="col-md-12" id="notify" data-offset-top="-1">
                        <div class=" px-3 justify-content-center align-items-center">
                            <form class="row">
                                ...
                                <div class="col-sm-12 col-md-6 form-group">
                                    <label class="text-uppercase">Nombre del curso: <strong
                                ...
                                <div class="col-sm-12 col-md-6 form-group">
                                    <label for="validationCustom06">EJECUTIVO <strong
                                            class="text-danger">*</strong></label>
                      ...
                      ?>
                                ...
                                <div class="col-sm-12 col-md-6 form-group">
                                    <label class="text-uppercase">Correo Empresarial: <strong
                                            class="text-danger">*</strong></label>
                                    <input class="form-control form-control-2" type="email" id="CorreoEmpresarial"
                                        name="CorreoEmpresarial">
                                </div>
                                <div class="col-sm-12 col-md-6 form-group">
                                    <label class="text-uppercase">Correo Personal: <strong
                                            class="text-danger">*</strong></label>
                                    <input class="form-control form-control-2" type="email" id="CorrePersonal"
                                        name="CorrePersonal">
                                </div>
                                <div class="col-sm-12 col-md-6 form-group">
                                    <label class="text-uppercase">WhatsApp personal: <strong
                                            class="text-danger">*</strong></label>
                                ...
                                <div class="col-md-6 margin-top-2x text-left">
                                    ...
                                    <ul class="text-left">
                                        <p> <strong class="text-danger"> 1.</strong> Antes de pagar y/o realizar la
                                            factura del servicio, es necesario consultar
                                        ...
                                        <p><strong class="text-danger"> 2.</strong> Para asegurar el lugar del
                                            participante, es necesario enviar OC (en caso de
                                            crédito), ficha de pago o depósito y/o factura del servicio (curso), además
                                            del
                                            formato MKT-FOR-705 Rev08 con los datos del participante, de lo contrario no
                                            se realizará el registro y el lugar quedará libre para otros interesados.
                                        </p>

                                        <p><strong class="text-danger"> 3.</strong> No se harán reembolsos. En caso de
                                            cancelación de asistencia por parte del
                                            ...
                                            asistencia en otro ciclo de cursos impartido en las instalaciones de la
                                            empresa,
                                        ...
                                        <p><strong class="text-danger"> 4.</strong> Curso de cortesía: éste debe ser
                                            autorizado por gerencia, con validación de
                                            cupo antes de confirmación al cliente, deberá tomarlo en el mes en curso en
                                            el
                                        ...
                                        <p><strong class="text-danger"> 5.</strong> El registro por participante es de
                                            manera individual por lo que, deberá </p>
                                    </ul>
                                </div>
                                <div class="col-md-6 margin-top-2x">
                                    ...
                                    <hr class="margin-bottom-1x">
                                    <ul class="text-left">
                                        <p> presentarse de manera presencial únicamente la persona inscrita; No se
                                            permitirá
                                            el acceso a las instalaciones a cualquier otra persona ajena a la empresa
                                            que
                                            contrata el servicio</p>
                                        <p><strong class="text-danger"> 6.</strong> Cuando surja algún cambio de
                                            participante, será necesario notificar a su
                                            ejecutivo de ventas y al correo marketing.directo@splittel.com con un mínimo
                                            de
                                        ...
                                        <p><strong class="text-danger"> 7.</strong> En el caso de que el participante no
                                            se presente el día del curso y no haya
                                        ...
                                        <p><strong class="text-danger"> 8.</strong> Para el certificado de
                                            participación, se tomará en cuenta el nombre del
                                            asistente y el nombre de la empresa (nombre comercial o de facturación) que
                                            realiza la compra del servicio (de acuerdo al formato MKT-FOR-705 Rev08).
                                        </p>
                                        <p><strong class="text-danger"> 9.</strong> En caso de extravió y/o requerir
                                            duplicado del certificado de participación, se
                                            proporcionará gratis de forma digital y/o impresa las veces que sea
                                            requerido de
                                        ...
                                        <p><strong class="text-danger"> 10.</strong> Para emitir el formato DC3 y
                                            certificado de participación, el asistente deberá
                                            llenar el formato antes de finalizar el curso y aprobarlo con una
                                            calificación
                                            mínima de 80/100 en examen final, el instructor firmará y entregará el
                                            certificado
                                ...
                                <div class="col-sm-12 col-md-12 form-group text-center">
                                    ...
                                    <button type="button" id="botonenviar" class="btn btn-primary "
                                        onclick="EnviarAlta()">Enviar</button>
