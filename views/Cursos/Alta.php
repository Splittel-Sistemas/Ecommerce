            ...
            <div class=" px-3 justify-content-center align-items-center">
              <form class="row">
                <div class="col-sm-12 col-md-6 form-group text-center">
                  <h6 class="text-muted text-lg text-uppercase bg-primary text-white">1.- INFORMACIÓN</h6>
                ...
                <div class="col-sm-12 col-md-12 form-group text-center">
                  <ul>
                    <p>Favor de indicar datos personales del participante ya que se les realizará el envió de la confirmación a través del
                      correo electrónico y de un whatsapp personalizado. <b>Tomar en cuenta que la información que se proporcione
                ...
                <br>
                <div class="col-sm-12 col-md-6 form-group text-center">
                  <h6 class="text-muted text-lg text-uppercase bg-primary text-white">2.- DATOS PERSONALES</h6>
                ...
                <div class="col-sm-12 col-md-6 form-group">
                  <label class="text-uppercase">Nombre y Título: <strong class="text-danger">*</strong></label>
                ...
                <div class="col-md-6 margin-top-2x text-left">
                  ...
                  <h6 class="text-muted text-lg text-uppercase bg-primary text-white text-center">POLÍTICA DE CURSOS SPLITTEL:</h6>
                  <hr class="margin-bottom-1x">
                  <ul class="text-left">
                    <p> <strong class="text-danger"> 1.</strong> Antes de pagar y/o realizar la factura del servicio, es necesario consultar
                      disponibilidad de lugares, ya que los cursos tienen cupo limitado.</p>
                    <p><strong class="text-danger"> 2.</strong> Para asegurar el lugar del participante, es necesario enviar OC (en caso de
                      crédito), ficha de pago o depósito y/o factura del servicio (curso), además del
                      formato MKT-FOR-705 Rev08 con los datos del participante, de lo contrario no
                      se realizará el registro y el lugar quedará libre para otros interesados.</p>

                    <p><strong class="text-danger"> 3.</strong> No se harán reembolsos. En caso de cancelación de asistencia por parte del
                      cliente, la misma deberá ser con un mínimo de 2 días hábiles de anticipación
                      previa a la semana de cursos. Por lo que, se podrá reprogramar la fecha de
                      asistencia en otro ciclo de cursos impartido en las instalaciones de la empresa,
                      únicamente con previa confirmación (solo 1 vez en un plazo máximo de 3
                      meses). En caso de no haber confirmación para reprogramación antes de
                      cumplirse el plazo máximo se dará por pérdido el curso.</p>
                    <p><strong class="text-danger"> 4.</strong> Curso de cortesía: éste debe ser autorizado por gerencia, con validación de
                      cupo antes de confirmación al cliente, deberá tomarlo en el mes en curso en el
                      que fue autorizado, en caso de requerir reprogramación, ésta será únicamente
                ...
                <div class="col-md-6 margin-top-2x">
                  ...
                  <ul class="text-left">
                    ...
                    <p><strong class="text-danger"> 8.</strong> Para el certificado de participación, se tomará en cuenta el nombre del
                      ...
                      realiza la compra del servicio (de acuerdo al formato MKT-FOR-705 Rev08).</p>
                    <p><strong class="text-danger"> 9.</strong> En caso de extravió y/o requerir duplicado del certificado de participación, se
                      proporcionará gratis de forma digital y/o impresa las veces que sea requerido de
                      acuerdo a la solicitud del cliente con los datos de emisión originales.</p>
                    <p><strong class="text-danger"> 10.</strong> Para emitir el formato DC3 y certificado de participación, el asistente deberá
                      llenar el formato antes de finalizar el curso y aprobarlo con una calificación
                      mínima de 80/100 en examen final, el instructor firmará y entregará el certificado
                      con validez ante la STPS 24 horas después del curso.</p>
                ...
                <div class="col-md-8 margin-top-2x text-left">
                  <h6 class="text-muted text-lg text-uppercase bg-primary text-white text-center">CONTACTO</h6>

                  <hr class="margin-bottom-1x">
                  <ul>
                    <p>FIBREMEX S.A. DE C.V.
                      Parque Tecnológico Innovación Querétaro, Carretera Estatal 431, km.2+200, Int. 28,
