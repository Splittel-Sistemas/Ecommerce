  ...
  function(response){
    ...
    if (lineaCredito) {
      ...
      let ultimosDigitosTarjeta = numeroTarjeta.substr(-4)
          metodoPago            = '<span class="text-muted">Tarjeta: </span>**** **** **** '+ultimosDigitosTarjeta+'<span></span>'
    }
    ...
    document.getElementById('resumen-datosEnvio-telefono').innerHTML        = document.getElementById('datosEnvio-telefono-'+checkDatosEnvio).innerHTML
    
    document.getElementById('resumen-paqueteria').innerHTML = Paqueteria.value
 ...
 * @return {number} b - Bar
 */
document.getElementById("CFDIUser").value = "G01"; 
